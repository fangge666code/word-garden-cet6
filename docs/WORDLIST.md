...
当前版本收录 3000 个 CET-6 核心学习词条。升级前的 1500 个词及其 ID 保持稳定，新增词条从 MIT License 的 ECDICT 中筛选：保留带有 `cet6` 标签的单词（其中可能也包含大学英语学习必需的基础词），并按照 BNC 和当代语料库词频优先选择。
...
- 扩充来源许可：https://github.com/skywind3000/ECDICT/blob/master/LICENSE
